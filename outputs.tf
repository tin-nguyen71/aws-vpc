...
output "default_network_acl_id" {
  ...
  value       = try(aws_vpc.vpc[0].default_network_acl_id, "")
}
...
output "vpc_ipv6_association_id" {
  ...
  value       = try(aws_vpc.vpc[0].ipv6_association_id, "")
}

output "vpc_ipv6_cidr_block" {
  description = "The IPv6 CIDR block"
  value       = try(aws_vpc.vpc[0].ipv6_cidr_block, "")
}

output "vpc_secondary_cidr_blocks" {
  description = "List of secondary CIDR blocks of the VPC"
  value       = compact(aws_vpc_ipv4_cidr_block_association.secondary_cidr_blocks[*].cidr_block)
}

output "vpc_owner_id" {
  description = "The ID of the AWS account that owns the VPC"
  value       = try(aws_vpc.vpc[0].owner_id, "")
}
...
output "dhcp_options_id" {
  ...
  value       = try(aws_vpc_dhcp_options.dhcp[0].id, "")
}
...
output "transit_gateway_attachment_id" {
  value       = try(aws_ec2_transit_gateway_vpc_attachment.transit_gateway_attachment[0].id, "")
